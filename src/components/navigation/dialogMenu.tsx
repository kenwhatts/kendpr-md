...
export function DialogMenu({
  ...
  return (
    <dialog
      ...
      aria-hidden={true}>
      <div
        className="bg-primary-darker border-border-color flex w-3/4 max-w-[500px] scale-0 flex-col-reverse rounded-2xl border px-[clamp(1rem,5%,2rem)] py-4 opacity-50 transition-all duration-200 ease-out group-open:scale-100 group-open:opacity-100"
        tabIndex={0}
        aria-label="Menu"
